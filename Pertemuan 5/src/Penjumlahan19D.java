...
class utamaPenjumlahan19D {
    public static void main(String[] args) {
        ...
        Penjumlahan19D sm19D = new Penjumlahan19D(elemen19D);

        System.out.println("==========================================================");
        for (int i = 0; i < sm19D.elemen19D; i++) {
            System.out.printf("Masukkan keuntungan bulan ke-%d: ", (i + 1));
            sm19D.keuntungan19D[i] = rayhan19D.nextDouble();
        }

        System.out.println("==========================================================");
        System.out.println("Perhitungan dengan algoritma Brute Force");
        System.out.printf("Total keuntungan perusahaan selama %d bulan: %.5f\n", sm19D.elemen19D,
                sm19D.totalBF19D(sm19D.keuntungan19D));
        System.out.println("==========================================================");
        System.out.printf("Total keuntungan perusahaan selama %d bulan: %.5f\n", sm19D.elemen19D,
                sm19D.totalDC19D(sm19D.keuntungan19D, 0, (sm19D.elemen19D - 1)));
